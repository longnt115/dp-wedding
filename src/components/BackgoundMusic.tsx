    ...
    <>
      ...
      >
        <div
          ...
          ref={toggleRef}
          className={`bg-white self-center py-[0.7rem] w-[320px] pl-3 border-1 border-wedding-primary rounded-l-full mr-[-1.5rem] shadow-md text-gray-700 whitespace-nowrap overflow-hidden transition-all duration-1000 ease-out origin-right ${
        ...
        <button
          id="icon-music"
          className={`rounded-full bg-white shadow-lg z-50 cursor-pointer transition-transform hover:scale-110 active:scale-100 focus:outline-none focus:ring-2 focus:ring-wedding-primary focus:ring-offset-2 ${
        ...
        >
          <div
            className={`bg-white rounded-full border-2 p-1 shadow-md transition-colors ${
              isPlaying ? "border-wedding-primary" : "border-gray-300"
            }`}
          >
            <Image
              src={
